...
__webpack_require__(2); // import siblings from 'service-functions/siblings'
//- WITH JQUERY===================================
//- jquery--------------------------
...
var Slideout = __webpack_require__(3); //- multilevel-panel--------------------------
...
__webpack_require__(4); //- micromodal--------------------------


var MicroModal = __webpack_require__(5); //- swiper--------------------------
...
document.addEventListener('DOMContentLoaded', function () {
  tippy('[data-tippy-content]'); //---------------Swiper
...
(function () {
  var singleDropdown = function singleDropdown(opts) {
  ...
  return function e(t, n, r) {
    ...
    1: [function (require, module, exports) {
      ...
      function Slideout(options) {
        ...
        this._moved = false;
        this._opened = false;
        this._preventOpen = false; // Sets panel

        this.panel = options.panel;
        this.menu = options.menu; // Sets options
        ...
        this._translateTo *= this._orientation; // Sets  classnames
  ...
  var Combine = function Combine(combine) {
    ...
    this.clickHandler = function (e) {
      ...
      var target = e.target.closest('.tab'),
          ...
          siblings = parent.querySelectorAll('.tab'); // target.classList.add('active');
