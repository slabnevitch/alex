...
core_class.use([navigation, mousewheel]); //- SERVIVE FUNCTIONS==================
//- remove-class--------------------------
...
__webpack_require__(0); //- WITH JQUERY===================================
//- jquery--------------------------
...
__webpack_require__(1); //- micromodal--------------------------


var MicroModal = __webpack_require__(2); //- swiper--------------------------
...
var tingle = __webpack_require__(3); //- end VANILLA JS===================================
  ...
  if (document.querySelector('.works__cards') !== null) {
    var swiper = new core_class('.works__cards', {
      ...
      */
      ...
      mousewheel: {
        invert: true,
        eventsTarget: '.works__cards' // releaseOnEdges: true
